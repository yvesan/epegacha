...
// Total Probability Check: 19.52+10+3+2+15+10+8+3+6+1.5+8+5+5+2+1+0.5+0.24+0.24 = 100%

export const PRIZE_POOL: Prize[] = [
  // 1. 纯空奖 (19.52%)
  { id: 'p_empty', name: '再接再厉', type: PrizeType.EMPTY, value: 0, probability: 19.52, rarity: Rarity.COMMON, description: '差一点点就中了！' },
  
  // 2. 积分返还奖 (15%)
  { id: 'p_pt_5', name: '5积分', type: PrizeType.POINT, value: 5, probability: 10.0, rarity: Rarity.COMMON, description: '价值1元' },
  { id: 'p_pt_10', name: '10积分', type: PrizeType.POINT, value: 10, probability: 3.0, rarity: Rarity.COMMON, description: '价值2元' },
  ...
  { id: 'p_cash_10', name: '10元红包', type: PrizeType.CASH, value: 10, probability: 10.0, rarity: Rarity.UNCOMMON, description: '微信红包' },
  { id: 'p_cash_20', name: '20元红包', type: PrizeType.CASH, value: 20, probability: 8.0, rarity: Rarity.RARE, description: '微信红包' },
  { id: 'p_cash_100', name: '100元红包', type: PrizeType.CASH, value: 100, probability: 3.0, rarity: Rarity.LEGENDARY, description: '大额红包！' },

  // 4. 课程代金券 (7.5%)
  { id: 'p_vou_50', name: '50元课程券', type: PrizeType.VOUCHER, value: 50, probability: 6.0, rarity: Rarity.UNCOMMON, description: '课程代金券' },
  { id: 'p_vou_200', name: '200元课程券', type: PrizeType.VOUCHER, value: 200, probability: 1.5, rarity: Rarity.RARE, description: '大额课程券' },

  // 5. 实物奖品 (21.5%)
  { id: 'p_item_drink', name: '运动饮料/能量棒', type: PrizeType.PHYSICAL, value: 5, probability: 8.0, rarity: Rarity.COMMON, description: '补充能量' },
  { id: 'p_item_badge', name: '纪念徽章', type: PrizeType.PHYSICAL, value: 20, probability: 5.0, rarity: Rarity.UNCOMMON, description: '限量版' },
  { id: 'p_item_gear', name: '随机运动装备', type: PrizeType.PHYSICAL, value: 55, probability: 5.0, rarity: Rarity.RARE, description: '跳绳/瑜伽垫等' },
