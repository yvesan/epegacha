...
// Total Probability Check: 19.92 + 36 + 19.1 + 4 + 20.5 + 0.48 = 100%
...
export const PRIZE_POOL: Prize[] = [
  ...
  { id: 'p_cash_100', name: '100元红包', type: PrizeType.CASH, value: 100, probability: 1.0, rarity: Rarity.LEGENDARY, description: '大额红包！' },

  // 4. 课程代金券 (4%)
  { id: 'p_vou_50', name: '50元课程券', type: PrizeType.VOUCHER, value: 50, probability: 3.0, rarity: Rarity.UNCOMMON, description: '课程代金券' },
  { id: 'p_vou_200', name: '200元课程券', type: PrizeType.VOUCHER, value: 200, probability: 1.0, rarity: Rarity.RARE, description: '大额课程券' },
  ...
  { id: 'p_item_gear', name: '随机运动装备', type: PrizeType.PHYSICAL, value: 55, probability: 5.0, rarity: Rarity.RARE, description: '跳绳/瑜伽垫/哑铃/握力器/实心球' },
