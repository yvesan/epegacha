...
export const PRIZE_POOL: Prize[] = [
  ...
  // 2. 积分返还奖 (41.3%)
  { id: 'p_pt_5', name: '5积分', type: PrizeType.POINT, value: 5, probability: 22.1, rarity: Rarity.COMMON, description: '价值10元' },
  { id: 'p_pt_10', name: '10积分', type: PrizeType.POINT, value: 10, probability: 12.1, rarity: Rarity.COMMON, description: '价值20元' },
